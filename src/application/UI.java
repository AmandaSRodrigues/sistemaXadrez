...
public class UI { // abreviacao de Using Interface
	...
	public static PosicaoXadrez lerPosicaoXadrez(Scanner sc) {
		try {
			...
			throw new InputMismatchException("Erro ao ler posicao de xadrez. Os valores validos sao de a1 ate h8.");
		}
	}
	...
	private static void printPeca(PecaXadrez peca, boolean colorirFundo) {
		if (colorirFundo) {
